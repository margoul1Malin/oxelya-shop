...
export const metadata: Metadata = {
  title: 'Oxelya Shop - Conditions Générales de Vente',
  ...
  applicationName: 'Oxelya Shop - Conditions Générales de Vente',
  appleWebApp: {
    title: 'Oxelya Conditions Générales de Vente',
...
export default function ConditionsGeneralesDeVenteLayout({
  children,
}: {
